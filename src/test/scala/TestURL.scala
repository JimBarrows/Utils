...
import bizondemand.utils.models.{Parameter, URL}

class TestUrl extends JUnit4(UrlSpec)
object UrlSpec extends Specification {
  "An url class" should {
    ...
    "represent http://localhost/some/path/to/some/resource.html" in {
      ...
      new URL("http", None, None, "localhost", None, Some("some" :: "path" :: "to" :: "some" :: "resource.html" :: Nil), None).toString must beEqualTo("http://localhost/some/path/to/some/resource.html")
    }
    ...
    "represent http://localhost/some/path/to/some/resource.html?param1=val1&param2=val2" in {
      ...
      new URL("http",
        ...
        None,
        Some("some" :: "path" :: "to" :: "some" :: "resource.html" :: Nil),
        Some(Parameter("param1", "val1") :: Parameter("param2", "val2") :: Nil)).toString must beEqualTo("http://localhost/some/path/to/some/resource.html?param1=val1&param2=val2")
    }
